...
Marty can't finish the strategy without these. Ordered by how much they block.
Answer inline, or in chat and Marty will file them.

## Blocking — strategy can't be finalized
...
| - | -------- | -------------- |
| 6 | **Narrowed 2026-09-16.** Patrick is partial to short-form video and to TikTok, so the willingness question is answered. What's still open: will he appear *on camera himself*, and can filming happen during work he's already doing rather than as a separate shoot? | The second half is the real one — a separate shoot costs Patrick-hours we don't have. The content format is hands-only by default, so his face is upside, not a dependency. |
